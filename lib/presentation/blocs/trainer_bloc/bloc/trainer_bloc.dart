  ...
  void _onAddQuestion(AddQuestion event, Emitter<TrainersState> emit) async {
    ...
    for (Trainer element in allTrainers) {
      if (element.name == "Свой тренажер") {
        ...
        allTrainers.removeAt(element.id - 1);
        ...
        //   stringId.add("${i.id}");
        // }
        // dataBase.deleteTheme(element.id);
        // final dbb = db.TrainersCompanion(
        //   name: Value<String>(element.name),
        //   color: Value<String?>(element.color),
        //   image: Value<String?>(element.image),
    ...
    //       db.QuestionsComplete? quest =
    //           await dataBase.getQuestionFullInfoById(c);
    ...
    //   final t = state.trainerList[2].questions;
    //   t.add(question);
    //   final trainers = [
    //     state.trainerList[0],
    //     state.trainerList[1],
    //     Trainer(
    //         id: state.trainerList[2].id,
    //         name: state.trainerList[2].name,
    //         color: state.trainerList[2].color,
    //         image: state.trainerList[2].image,
    //         questions: t)
    //   ];
    //   final tr = [
